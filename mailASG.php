...
$query0 = mysqli_query($conn, "SELECT MIN(waitingPosition) FROM tblWaitingList WHERE courseID = 'ASG101'");
...
$insert1 = "INSERT INTO tblScheduled (id, courseID) VALUES ('$customid', 'ASG101')";
$query3 = mysqli_query($conn, $insert1);



//THIS SECTION REMOVES THE STUDENT FROM THE WAIT LIST SINCE IT IS NO LONGER NEEDED
$delete9 = "DELETE FROM tblWaitingList WHERE id = '$customid' && courseID = 'ASG101'";
